const TeamSection = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center bg-black py-20">
      <div className="max-w-[800px] mx-auto px-8 text-center">
        <h2 className="text-white text-3xl md:text-4xl lg:text-[44px] font-semibold leading-tight tracking-wide mb-8">
          Наша команда создает
          <br />
          такие системы
        </h2>

        <p className="text-white/80 text-base md:text-lg font-light leading-relaxed tracking-wide mb-12 max-w-[650px] mx-auto">
